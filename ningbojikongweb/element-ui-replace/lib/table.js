...
var external_normalize_wheel_ = __webpack_require__(45);
...
var table_layout_TableLayout = function () {
  function TableLayout(options) {
    ...
    this.gutterWidth = 0; // scrollbarWidth();
  ...
  TableLayout.prototype.setShowHeader = function setShowHeader(value) {
  ...
  watch: {
    showHeader: {
      ...
      handler: function handler(value) {
        this.layout.setShowHeader(value);
      }
    },
