  ...
  <div>
    <ss-condition-area ref="conditionPage" @setConditionFlag="setConditionFlag">
      ...
      <div class="mt_10" style="display:flex;">
        ...
        <!-- Excel批量导入 -->
        <ss-custom-button @click="importBtn" :type="$consts.CUSTOMBUTTONTYPES.import" class="ml_10" />
        <!-- <batchImportBtn @upload="uploadFile" @progress="progress" @uploadEnd="uploadEnd" ref="uploadPro"
          class="import ml_10">
        </batchImportBtn> -->
        <batchImportBtn :visible="importVisible" @upload="uploadFile" @close="importClose" @progress="progress" @uploadEnd="uploadEnd" ref="uploadPro"></batchImportBtn>
    ...
    <div class="remark-bottom" ref="remarkPage">
      备注：导入者可查看对应的明文身份证件号。
    </div>
