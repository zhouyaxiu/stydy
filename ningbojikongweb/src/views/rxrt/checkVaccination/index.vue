  ...
  <div class="checkVaccination">
    ...
    <div style="position:relative;">
      <custom-in-table :changeRowBg="true" :rowBgList="tipList" :changeRowAttr="'stuIsjz'" style="width: 100%"
        @selectionChange="handleSelectionChange" :data="dataList" :columnData="columnData" ref="tabPage" class="vaccination" :pageSize="20" :changeNull="true" @goPage="search" @rowOperateFun="rowOperateFun" :pagenum="pagenum" :total="total"></custom-in-table>
