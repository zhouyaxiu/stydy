<template>
  ...
  */
  ...
  <div style="display: inline-block" class="datePicker">
    <el-date-picker :popper-class="popperClass" :clearable="clearable" style="width: 140px" v-model="startdate"
      :type="dateType" :placeholder="startPlaceholder" :format="valueFormat" :value-format="valueFormat" :editable="false"
      :picker-options="startTimeOption ? startTimeOption : startDefaultTimeOption
        " @change="emitDate" :disabled="disabledFlag"></el-date-picker>
    <span> 至 </span>
    <el-date-picker :popper-class="popperClass" :clearable="clearable" style="width: 140px" v-model="enddate"
      :type="dateType" :placeholder="endPlaceholder" :format="valueFormat" :value-format="valueFormat" :editable="false"
      :picker-options="endTimeOption ? endTimeOption : endDefaultTimeOption" @change="emitDate"
      :disabled="disabledFlag"></el-date-picker>
  </div>
</template>
