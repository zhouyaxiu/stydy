...
export default {
  ...
  downloadFile (url, params, fileName) {
    ...
    params.accountName = store.state.userName
    ...
    params.areaCodeSelect = JSON.parse(sessionStorage.getItem('response')).userinfo.areaCode
    params.areaLevelSelect = JSON.parse(sessionStorage.getItem('response')).arealevel
    if (params.operateType == 4 || params.operateType == 6) {
      params.areaCode = sessionStorage.getItem('areacodeSelect')
      params.areaLevel = sessionStorage.getItem('areaLevelSelect')
    }
    if (!fileName) {
  ...
  axiosLogin (url, params) {
    ...
    // params.userName = store.state.account
    // params.loginname = sessionStorage.getItem('account')
    // params.modelName = sessionStorage.getItem('title') || '登录'
