...
/* harmony default export */ var cascader_nodevue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    renderExpandIcon: function renderExpandIcon(h) {
      ...
      return h('i', external_babel_helper_vue_jsx_merge_props_default()([{ 'class': 'el-icon-arrow-right el-cascader-node__postfix'
      }, events]));
    },
  ...
  render: function render(h) {
    ...
    var inActivePath = this.inActivePath,
        ...
        nodeId = this.nodeId;
    var expandTrigger = config.expandTrigger,
        checkStrictly = config.checkStrictly; // const { expandTrigger, checkStrictly, multiple } = config;
