...
/* harmony default export */ var select_dropdownvue_type_script_lang_js_ = ({
  ...
  watch: {
    ...
    '$parent.visible': function $parentVisible(val) {
      var _this = this;
      ...
      if (val) {
        this.$nextTick(function () {
          _this.$refs.dropdown.style.transform = _this.transform;
        });
      }
    }
  },
  ...
  mounted: function mounted() {
    ...
    this.$on('updatePopper', function () {
      if (_this2.$parent.visible) _this2.updatePopper();
    });
...
/* harmony default export */ var selectvue_type_script_lang_js_ = ({
  ...
  directives: {
    ...
    scroll: {
      inserted: function inserted(el, binding, vnode) {
        ...
        el._scrolldirective_ = MouseWheel;
        var obj = el;
        while (obj.parentElement) {
          obj = obj.parentElement;
          obj.addEventListener('scroll', MouseWheel);
        }
      },
      unbind: function unbind(el, binding, vnode) {
        var MouseWheel = el._scrolldirective_;
        delete el._scrolldirective_;
        var obj = el;
        while (obj.parentElement) {
          obj = obj.parentElement;
          obj.removeEventListener('MouseWheel', MouseWheel);
        }
      }
    }
  },
  ...
  mounted: function mounted() {
    ...
    if (reference && reference.$el) {
      ...
      var input = [].filter.call(reference.$el.childNodes, function (item) {
        return item.tagName === 'INPUT';
      })[0];
