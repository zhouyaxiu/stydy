...
<template>
  <div class="in-out-flow">
    <div ref="inoutFlow" id="inoutFlow" :style="{ transitionDuration: `${transitionDuration}ms`, transform: `translateY( ${translateX}px)`}"></div>
  </div>
</template>
<script setup>
...
const draw = async () => {
  let vaccines = [...data.value.vaccines,...data.value.vaccines,...data.value.vaccines,...data.value.vaccines,...data.value.vaccines,...data.value.vaccines,...data.value.vaccines,...data.value.vaccines,...data.value.vaccines,...data.value.vaccines]
  let outflows = [...data.value.outflows,...data.value.outflows,...data.value.outflows,...data.value.outflows,...data.value.outflows,...data.value.outflows,...data.value.outflows,...data.value.outflows,...data.value.outflows,...data.value.outflows]
  let inflows =  [...data.value.inflows,...data.value.inflows,...data.value.inflows,...data.value.inflows,...data.value.inflows,...data.value.inflows,...data.value.inflows,...data.value.inflows,...data.value.inflows,...data.value.inflows]
  let option = {
    tooltip: {
      show: true,
      // appendToBody: true,
  ...
  let vaccLen=data.value.vaccines.length
  timer=setInterval(()=>{
  // if(option.dataZoom.endValue==vaccLen){
  //   // data.value.vaccines=vaccines
  //   // data.value.outflows=outflows
  //   // data.value.inflows=inflows
  //   option.dataZoom.endValue=16
  //   option.dataZoom.startValue=10
  //   // arrvaccines=[]
  //   // arroutflows=[]
  //   // arrinflows=[]
  //   console.log(data.value.vaccines,'vaccines')
  // }
  // else if(option.dataZoom.endValue==17){
  //   data.value.vaccines=vaccines
  //   data.value.outflows=outflows
  //   data.value.inflows=inflows
  //   option.dataZoom.endValue=6
  ...
  //   // arrvaccines.push(vaccines.shift())
  //   // arroutflows.push(outflows.shift())
  //   // arrinflows.push(inflows.shift())
  // }
  option.dataZoom.endValue=option.dataZoom.endValue+1;
  option.dataZoom.startValue=option.dataZoom.startValue+1;
  // data.value.vaccines.push(data.value.vaccines.shift())
  // data.value.outflows.push(data.value.outflows.shift())
  // data.value.inflows.push(data.value.inflows.shift())
  inoutFlow.setOption(option, true);
},2500)
  inoutFlow.clear();
  inoutFlow.setOption(option, true);
