...
public class RedisServiceImpl implements RedisService<String, Object> {
	...
	protected final static Logger log = LoggerFactory.getLogger(RedisServiceImpl.class);
    ...
    @Override
    public Set<String> getAllKeys(String regKey) {
        return redisTemplate.keys(regKey);
    }


    @Override
    public Map<String, Object> getAllString(String regKey) {
        Set<String> stringSet = getAllKeys(regKey);
    ...
    @Override
    public Map<String, Set<Object>> getAllSet(String regKey) {
        Set<String> stringSet = getAllKeys(regKey);
        Map<String, Set<Object>> map = new HashMap<String, Set<Object>>(20);
        Iterator<String> iterator = stringSet.iterator();
        while (iterator.hasNext()) {
            String k = iterator.next();
    ...
    @Override
    public Map<String, Set<Object>> getAllZSetRange(String regKey) {
        Set<String> stringSet = getAllKeys(regKey);
        Map<String, Set<Object>> map = new HashMap<String, Set<Object>>(20);
        Iterator<String> iterator = stringSet.iterator();
        while (iterator.hasNext()) {
    ...
    @Override
    public Map<String, Set<Object>> getAllZSetReverseRange(String regKey) {
        Set<String> stringSet = getAllKeys(regKey);
        Map<String, Set<Object>> map = new HashMap<String, Set<Object>>(20);
        Iterator<String> iterator = stringSet.iterator();
        while (iterator.hasNext()) {
    ...
    @Override
    public Map<String, List<Object>> getAllList(String regKey) {
        Set<String> stringSet = getAllKeys(regKey);
        Map<String, List<Object>> map = new HashMap<String, List<Object>>(20);
        Iterator<String> iterator = stringSet.iterator();
        while (iterator.hasNext()) {
            String k = iterator.next();
    ...
    @Override
    public Map<String, Map<String, Object>> getAllMap(String regKey) {
        Set<String> stringSet = getAllKeys(regKey);
...
//    }
    ...
    @Override
    public boolean getZSetRank(String key, Object value) {
        Long rank = redisTemplate.boundZSetOps(key).rank(value);
        return rank != null;
    }
