...
public interface RedisService<K, V> {
     ...
     * @return
     */
    Set<K> getAllKeys(String regKey);
     ...
     * @return
     */
    Map<K, V> getAllString(String regKey);
     ...
     * @return
     */
    Map<K, Set<V>> getAllSet(String regKey);
     ...
     * @return
     */
    Map<K, Set<V>> getAllZSetReverseRange(String regKey);
     ...
     * @return
     */
    Map<K, Set<V>> getAllZSetRange(String regKey);
     ...
     * @return
     */
    Map<K, List<V>> getAllList(String regKey);
     ...
     * @return
     */
    Map<K, Map<K, V>> getAllMap(String regKey);
     ...
     * @param value
     */
    Long increment(final K key, long value);
     ...
     * @return
     */
    Boolean setIfAbsent(final K key, V value);
     ...
     * @param value
     */
    void set(final int key, V value);
     ...
     * @param value
     */
    void set(final long key, V value);
    ...
    boolean getZSetRank(String key, Object value);
}
