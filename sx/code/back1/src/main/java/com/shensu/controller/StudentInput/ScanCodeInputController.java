...
public class ScanCodeInputController {
    ...
    /*儿童编码查询*/
    @RequestMapping(value = "/queryPlStuNo", method = RequestMethod.POST)
    public Object queryPlStuNo(String params, HttpServletResponse response) {
        CommonRespBody com = new CommonRespBody();
        com.setSuccess(true);
        JSONObject object = new JSONObject();
        Calendar start = Calendar.getInstance();
        try {
            ...
            object= scanCodeService.queryByStuNo(info);
        } catch (Exception e) {
            com.setPopMsg(Constants.FAILMESSAGE);
            com.setSuccess(false);
            com.setCode(Constants.ResultFailCode);
    ...
    /*儿童编码保存*/
    @RequestMapping(value = "/savePlStuNo", method = RequestMethod.POST)
    public Object savePlStuNo(String params, HttpServletResponse response) {
        CommonRespBody com = new CommonRespBody();
        com.setSuccess(true);
        JSONObject object = new JSONObject();
        Calendar start = Calendar.getInstance();
        try {
            Map<String, Object> info = Sm4Util.getParams(params);
            object= scanCodeService.saveByStuNo(info);
        } catch (Exception e) {
            com.setPopMsg(Constants.FAILMESSAGE);
            com.setSuccess(false);
            com.setCode(Constants.ResultFailCode);
     ...
     * 扫码录入:条码查询
     */
    @RequestMapping(value = "/queryPlStu", method = RequestMethod.POST)
    public Object queryPlStu(String params, HttpServletResponse response) {
        CommonRespBody com = new CommonRespBody();
        com.setSuccess(true);
        JSONObject object = new JSONObject();
        Calendar start = Calendar.getInstance();
        try {
            Map<String, Object> info = Sm4Util.getParams(params);
            object= scanCodeService.queryPlStu(info);
        } catch (Exception e) {
            com.setPopMsg(Constants.FAILMESSAGE);
            com.setSuccess(false);
            com.setCode(Constants.ResultFailCode);
     ...
     * 条码：保存
     */
    @RequestMapping(value = "/savePlStu", method = RequestMethod.POST)
    public Object savePlStu(String params, HttpServletResponse response) {
        CommonRespBody com = new CommonRespBody();
        com.setSuccess(true);
        JSONObject object = new JSONObject();
        Calendar start = Calendar.getInstance();
        try {
            Map<String, Object> info = Sm4Util.getParams(params);
            object= scanCodeService.savePlStu(info);
        } catch (Exception e) {
            com.setPopMsg(Constants.FAILMESSAGE);
            com.setSuccess(false);
            com.setCode(Constants.ResultFailCode);
     ...
     * 扫码录入:姓名性别出生日期
     */
    @RequestMapping(value = "/queryStuByThreeCondition", method = RequestMethod.POST)
    public Object queryStuByThreeCondition(String params, HttpServletResponse response) {
        CommonRespBody com = new CommonRespBody();
        com.setSuccess(true);
        JSONObject object = new JSONObject();
        Calendar start = Calendar.getInstance();
        try {
            Map<String, Object> info = Sm4Util.getParams(params);
            object= scanCodeService.queryStuByThreeCondition(info);
        } catch (Exception e) {
            com.setPopMsg(Constants.FAILMESSAGE);
            com.setSuccess(false);
            com.setCode(Constants.ResultFailCode);
     ...
     * 条码：保存
     */
    @RequestMapping(value = "/saveStuByThreeCondition", method = RequestMethod.POST)
    public Object saveStuByThreeCondition(String params, HttpServletResponse response) {
        CommonRespBody com = new CommonRespBody();
        com.setSuccess(true);
        JSONObject object = new JSONObject();
        Calendar start = Calendar.getInstance();
        try {
            Map<String, Object> info = Sm4Util.getParams(params);
            object= scanCodeService.saveStuByThreeCondition(info);
        } catch (Exception e) {
            com.setPopMsg(Constants.FAILMESSAGE);
            com.setSuccess(false);
            com.setCode(Constants.ResultFailCode);
     ...
     * 打印补种通知单前
     */
    @RequestMapping(value = "/queryReplantMess", method = RequestMethod.POST)
    public Object queryReplantMess(String params, HttpServletResponse response) {
        CommonRespBody com = new CommonRespBody();
        com.setSuccess(true);
        JSONObject object = new JSONObject();
        Calendar start = Calendar.getInstance();
        try {
            Map<String, Object> info = Sm4Util.getParams(params);
            object= scanCodeService.queryReplateMess(info);
        } catch (Exception e) {
            com.setPopMsg(Constants.FAILMESSAGE);
            com.setSuccess(false);
            com.setCode(Constants.ResultFailCode);
     ...
     * 打印补证通知单前
     */
    @RequestMapping(value = "/queryReplantCard", method = RequestMethod.POST)
    public Object queryReplantCard(String params, HttpServletResponse response) {
        CommonRespBody com = new CommonRespBody();
        com.setSuccess(true);
        JSONObject object = new JSONObject();
        Calendar start = Calendar.getInstance();
        try {
            Map<String, Object> info = Sm4Util.getParams(params);
            object= scanCodeService.queryReplantCard(info);
        } catch (Exception e) {
            com.setPopMsg(Constants.FAILMESSAGE);
            com.setSuccess(false);
            com.setCode(Constants.ResultFailCode);
    ...
    public Object okSave(String params, HttpServletResponse response) {
        CommonRespBody com = new CommonRespBody();
        com.setSuccess(true);
        JSONObject object = new JSONObject();
        Calendar start = Calendar.getInstance();
        try {
            Map<String, Object> info = Sm4Util.getParams(params);
            object= scanCodeService.OKSave(info);
        } catch (Exception e) {
            com.setPopMsg(Constants.FAILMESSAGE);
            com.setSuccess(false);
            com.setCode(Constants.ResultFailCode);
