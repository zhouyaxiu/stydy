...
public class DTOConvertUtil {
    ...
    public static void infoBeanToStudent(InfoBeanSaas infoBean, HighStudent student){
    ...
    public static void infoBeanToStudentBrief(InfoBean infoBean, StudentBrief student){
        if (infoBean.getFchildno() != null){
            student.setStuNo(infoBean.getFchildno());
        }
    ...
    public static void infoBeanToStudentInfo(InfoBean infoBean, StudentInfo student){
        if (infoBean.getFchildno() != null){
            student.setStuNo(infoBean.getFchildno());
