<template>
  ...
  <div>
    ...
    <ss-table style="width: 100%" :data="dataList" :columnData="columnData" ref="tabPage" class="vaccination" :pageSize="$store.state.pagesize" :changeNull="true" @goPage="search" @rowOperateFun="rowOperateFun" :pagenum="pagenum" :total="total">
