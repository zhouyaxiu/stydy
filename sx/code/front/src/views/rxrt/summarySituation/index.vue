<template>
  ...
  <div>
    ...
    <customize-table id="printArea" :data="dataList" :columnData="columnData" ref="tabPage" class="vaccination" :pageSize="$store.state.pagesize" :changeNull="true" @goPage="search" :pagenum="pagenum" :total="total" :headerCellStyle="rowStyle"></customize-table>
  </div>
</template>
<script>
