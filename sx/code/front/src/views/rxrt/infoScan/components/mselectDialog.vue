<template>
  <el-dialog title="受种者已经存在的学校和门诊信息" :visible.sync="visible" :before-close="close" :lock-scroll="true" :append-to-body="true">
    <div slot="title" class="el-dialog__header">
      <span class="el-dialog__title">受种者已经存在的学校和门诊信息</span>
      <span class="title-tips">（点击保存后即转校到该校）</span>
    </div>
    ...
    <ss-table :data="gridData" ref="tabPage" class="infoTable">
      ...
      <el-table-column prop="stuStationName" align="center" min-width="160" label="所属门诊" show-overflow-tooltip />
...
<script>
import { saveAndChange } from '@/utils/axios/apis/infoScan'
export default {
