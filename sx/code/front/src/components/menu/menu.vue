<template>
    <el-menu :default-active="defaultActive" defaultOpenMenu="[menu0]" class="menu-plan el-menu-vertical-demo" :style="'overflow:auto;width:350px;max-height:' + leftHeight + 'px;'">
