  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: '/rxrt/showSchoolManageQuery',
          name: '学校管理',
          meta: {
            requireAuth: false
          },
        ...
        /******************信息扫码*****************/
        {
          ...
          component: resolve => require([
            '@/views/rxrt/infoScan/index'
          ], resolve)
        },
        {
          path: '/rxrt/batchImport',
          name: 'Excel批量导入',
          meta: {
            requireAuth: false
          },
          component: resolve => require([
            '@/views/rxrt/batchImport/index'
          ], resolve)
        },
       
        /*************特定疫苗查验接种信息************/
        {
          path: '/rxrt/speccheckVaccination',
          name: '特定疫苗查验接种信息',
          meta: {
            requireAuth: false
          },
          component: resolve =>
            require([
              '@/views/rxrt/speccheckVaccination/index'
            ], resolve)
        },
      
        /*************特定疫苗接种证查验汇总表************/
        {
          path: '/rxrt/specInspectionSummary',
          name: '特定疫苗接种证查验汇总表',
          meta: {
            requireAuth: false
          },
          component: resolve =>
            require([
              '@/views/rxrt/specInspectionSummary/index'
            ], resolve)
        },
        // 一期
        /******************信息查验*****************/
