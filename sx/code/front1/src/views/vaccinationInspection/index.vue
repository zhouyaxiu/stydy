...
export default {
  ...
  methods: {
    ...
    async reset() {
      ...
      // await this.findClaLevelNew({ schId: this.$store.state.schId, claNameYear: this.schoolYearList[0].claNameYear, lunci: sessionStorage.getItem('defaultLunci') })
      this.$refs.selectClass.unitManageForm.stuClalevel = ''
      // await this.findClassNew({ schId: this.$store.state.schId, claLevel: this.$refs.selectClass.unitManageForm.stuClalevel, claNameYear: this.schoolYearList[0].claNameYear, lunci: this.$refs.selectClass.unitManageForm.lunci })
      // this.$refs.selectClass.unitManageForm.classId = this.classesList && this.classesList.length > 0 ? [this.classesList[0].classId] : []
      // this.$refs.selectClass.unitManageForm.classNames = this.classesList && this.classesList.length > 0 ? [this.classesList[0].claName] : []
    ...
    exportExcelFun() {
      ...
      // // params.schName = this.unitManageForm.lunci
