<template>
  ...
  <div>
    <ss-condition-area ref="conditionPage" @setConditionFlag="setConditionFlag">
      <ss-class-select ref="selectClass" :isBindGrade="true" :classSelect="true" :isRequired="false" :stuClalevel="true" :classId="true" :classIdRequired="false"></ss-class-select>
    ...
    <div class="main-content">
      <ss-table id="printArea" style="width: 100%" :data="dataList" ref="tabPage" class="vaccination" :pageSize="20" :changeNull="true" @goPage="search" :pagenum="pagenum" :total="total">
    ...
    <export-dialog @callback="exportExcel" @handleClose="handleExportClose" :total="total" :typeStr="'补种反馈报表'" :dialogVisible="exportDialogVisible"></export-dialog>
  </div>
</template>
<script>
  import { queryReplantMess,outPutReplantMess } from '@/utils/axios/apis/replenishmentFeedback'
  ...
  export default {
    ...
    methods: {
      ...
      exportExcel (pageNum) {
        ...
        params.schName = '测试扫码' || this.$store.state.schName
