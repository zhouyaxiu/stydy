<template>
  ...
  -->
  <div class="notice">
    <el-descriptions direction="vertical" style="page-break-after:always;margin-bottom: 20px;" :column="1" border v-if="formData.stuData" v-for="stuData in formData.stuData" :key="stuData.stuName">
      <el-descriptions-item labelClassName="labelStyle">
        ...
        <div style="color:#333;">
          ...
          <div class="mt_10">
            ...
            <span v-if="formData.maintype == 0">
              <span class="bluetext">{{ stuData.belongPalceStation }}</span>社区卫生服务中心办理补种手续。
            </span>
          </div>
          ...
          <div v-if="formData.maintype == 0">
            <div class="mt_10">社区卫生服务中心地址：<span class="bluetext">{{ stuData.belongPlaceAddress }}</span></div>
            <div>联系电话：<span class="bluetext">{{ stuData.belongPhone }}</span></div>
