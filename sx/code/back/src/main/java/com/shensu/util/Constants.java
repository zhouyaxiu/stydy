...
public class Constants {
    ...
    public static final int ResultFailCode = 521;    //失败，错误信息 （接口报错）
    ...
    * */
     ...
     * 备份每次执行的条数
     * */
    public  final static  int   BACKSIZE=1000;
    ...
    public static final String SCH_DEFAULT_PWD = "SXcyxt@123456";
    ...
    * 导出类型*/
    ...
    public static Map<String, String>  STU_TYPE       = new HashMap<String, String>() {
        {
            put("1", "本县");
            put("3", "本市");
            put("4", "本省");
