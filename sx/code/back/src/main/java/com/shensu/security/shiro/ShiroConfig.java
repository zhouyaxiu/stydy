...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shirFilter(SecurityManager manager){
        ...
        filterChainDefinitionMap.put("/checkinfo/*", "anon");
        ...
        filterChainDefinitionMap.put("/integratedPlatform/*", "anon");
    ...
    //配置自定义的权限登录器
    @Bean(name="authRealm")
    public AuthRealm authRealm(@Qualifier("credentialsMatcher") MyHashedCredentialsMatcher matcher) {
