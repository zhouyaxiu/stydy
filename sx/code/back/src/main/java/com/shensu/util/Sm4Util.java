...
//                        str = StringUtils.replace(str, "\\", "\\\\");
     ...
     * @param key 密钥
     */
    public static Map<String,Object> decryptECB(String cipherText,String key) throws Exception {
        ...
        // 删除末尾填充的0
        bytes = Arrays.copyOf(bytes, zeroIndex);

        decryptStr = new String(bytes, ENCODING);
        System.out.println(decryptStr);
        map = JSONObject.parseObject(decryptStr, Map.class);
        return map;
    }

    public static void main(String[] args) throws Exception {
        Map<String,Object>  map = Sm4Util.getParams("0d43af2a716755223fafe6bcdae25ba9247a2191339e69127ef319b03ee56cfd1f0b1bc169deb5c3239ac66a9ec11aa3b29b9b53913ca486d51679c8326d01cf");
        System.out.println(map);
        System.out.println(Sm4Util.decryptEcb("0d43af2a716755223fafe6bcdae25ba9247a2191339e69127ef319b03ee56cfd1f0b1bc169deb5c3239ac66a9ec11aa3b29b9b53913ca486d51679c8326d01cf"));
