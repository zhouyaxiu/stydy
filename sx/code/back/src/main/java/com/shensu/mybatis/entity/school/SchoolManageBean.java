...
public class SchoolManageBean {
    ...
    /**
     * 学校类型  0：幼托机构、1：小学 2：初中 3：高中 4：大学
     */
    ...
    public static  String getSchTypeCn (String schType) {
        if ("0".equals(schType)) {
            return "幼托机构";
        } else if ("1".equals(schType)) {
            return "小学";
        } else if ("2".equals(schType)) {
            return "初中";
        } else if ("3".equals(schType)) {
            return "高中";
        } else if ("4".equals(schType)) {
            return "大学";
        }
        return schType;
    }
