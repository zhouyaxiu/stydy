<!-- 国家督察-新冠疫苗加强第2针分年龄汇总表（威斯克、神州、万泰）-->
<template>
  <div>
    <ss-condition-area>
      <div class="condition-row">
        ...
        <div class="item">
          ...
          <ss-all-vaccine-vendor ref="selectedVaccineVendor" :type="4"></ss-all-vaccine-vendor>
        </div>
      </div>
...
<script setup>
import { wswList, outputWsw } from "@/api/apis/gjdc";
