<!-- 国家督察-按人群分类的新冠病毒疫苗接种信息汇总表 详情 -->
<template>
  <el-dialog title="按人群分类的新冠病毒疫苗接种信息汇总表详情" v-model="visible" width="1200" :before-close="close"
  ...
  <ss-export-dialog @callback="exportExcel" @handleClose="handleExportClose" :total="total"
    :typeStr="'按人群分类的新冠病毒疫苗接种信息汇总表详情导出'" :dialogVisible="exportDialogVisible"></ss-export-dialog>
</template>
<script setup>
import { queryDetail, crowOutputDetail } from "@/api/apis/gjdc";
//自定义全局公共方法引用
