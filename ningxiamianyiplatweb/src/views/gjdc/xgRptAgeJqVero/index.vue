    ...
    <ss-condition-area>
      <div class="condition-row">
        ...
        <div class="item">
          ...
          <ss-all-vaccine-vendor ref="selectedVaccineVendor" :type="0"></ss-all-vaccine-vendor>
        </div>
      </div>
...
<script setup>
import { veroList, outputVeros } from "@/api/apis/gjdc";
