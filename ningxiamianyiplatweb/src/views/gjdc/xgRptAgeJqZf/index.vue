    ...
    <ss-condition-area>
      <div class="condition-row">
        ...
        <div class="item">
          ...
          <ss-all-vaccine-vendor ref="selectedVaccineVendor" :type="1"></ss-all-vaccine-vendor>
        </div>
      </div>
...
<script setup>
import { zfList, outputZf } from "@/api/apis/gjdc";
