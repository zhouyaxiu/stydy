    ...
    <ss-condition-area>
      <div class="condition-row">
        ...
        <div class="item">
          ...
          <ss-all-vaccine-vendor ref="selectedVaccineVendor" :type="2"></ss-all-vaccine-vendor>
        </div>
      </div>
...
<script setup>
import { lsList, outputLs } from "@/api/apis/gjdc";
