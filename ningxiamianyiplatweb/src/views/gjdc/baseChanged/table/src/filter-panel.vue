<template>
  <el-tooltip ref="tooltip" :visible="tooltipVisible" :offset="0" :placement="placement" :show-arrow="false"
    :stop-popper-mouse-event="false" teleported effect="light" pure :popper-class="filterClassName" persistent>
    <template #content>
      <div v-if="multiple">
    ...
    ns.e('list-item'),
    {
      [ns.is('active')]:
        ...
        <li v-for="filter in filters" :key="filter.value"
          :class="[ns.e('list-item'), ns.is('active', isActive(filter))]" :label="filter.value"
...
import { ElCheckbox, ElTooltip, ElScrollbar, ElIcon, Placement } from 'element-plus'
