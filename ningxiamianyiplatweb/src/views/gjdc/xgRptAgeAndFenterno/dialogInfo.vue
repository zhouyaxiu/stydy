<!-- 国家督察-新冠病毒疫苗分年龄、分企业接种信息汇总表详情 -->
<template>
  <el-dialog title="新冠病毒疫苗分年龄、分企业接种信息汇总表详情" v-model="visible" width="1200" :before-close="close"
  ...
  <ss-export-dialog @callback="exportExcel" @handleClose="handleExportClose" :total="total"
    :typeStr="'新冠病毒疫苗分年龄、分企业接种信息汇总表详情导出'" :dialogVisible="exportDialogVisible"></ss-export-dialog>
</template>
<script setup>
import { queryXgDeatil, outputDetail } from "@/api/apis/gjdc";
//自定义全局公共方法引用
