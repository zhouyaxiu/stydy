          ...
          <template v-for="item in menuList">
            <template v-if="item.supModules && item.supModules.length">
              <el-sub-menu class="menu-1" :index="item.index" :key="item.index">
                <template #title>
                  <child :id="item.id" :iconType="iconType"></child>
                ...
                <template v-for="subItem in item.supModules">
                  <el-sub-menu class="menu-2" v-if="subItem.supModules && subItem.supModules.length"
                    ...
                    <el-menu-item class="menu-3" v-for="(threeItem, i) in subItem.supModules" :key="i"
                      :index="threeItem.index" @click="clickHandler(threeItem)">
                      <template #title>
...
const child = defineComponent({
  ...
  // render(h) {
  //   const type = ["userSetting", "sysManage", "sysSetting", "jzmz", "cy"][h.$attrs.id]
  //   return h(type, h.$slots)
  //   console.log(h, '00000')
  // },
  props: {
    id: {
