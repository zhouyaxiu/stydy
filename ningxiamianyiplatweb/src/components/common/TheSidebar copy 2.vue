<template>
  <!-- 导航开始 -->
  <el-menu :default-active="defaultActive" class="el-menu-vertical-demo" unique-opened @open="handleOpen"
    @close="handleClose" @select="handleSelect" :default-openeds="defaultOpeneds">
    <menu-item v-for="item in datas" :key="item.index" :item="item"></menu-item>
  </el-menu>
  <!-- 导航结束 -->
</template>
        ...
        "supModules": [
          {
            "supModules": [],
            "supId": "1010011153",
            "updateDate": "2021-07-27 09:44:35",
            "moduleCode": "M1641",
            "moduleShortName": "新冠病毒疫苗医保正确数据统计表",
            "moduleName": "新冠病毒疫苗医保正确数据统计表",
            "updateUser": "集成超级管理员",
            "containOptions": "6",
            "id": "1010011154",
            "tableStatus": "0",
            "moduleUrl": "gjdc/insurance_query",
            "onOff": "1",
            "index": "/gjdc/insurance_query"
          },
          {
            "supModules": [],
            "supId": "1010011153",
            "updateDate": "2021-07-28 09:25:53",
            "moduleCode": "M1642",
            "moduleShortName": "新冠病毒疫苗医保错误数据统计（总表）",
            "moduleName": "新冠病毒疫苗医保错误数据统计（总表）",
            "updateUser": "集成超级管理员",
            "containOptions": "6",
            "id": "1010011155",
            "tableStatus": "0",
            "moduleUrl": "gjdc/insurance_allErrorQuery",
            "onOff": "1",
            "index": "/gjdc/insurance_allErrorQuery"
          },
          {
            "supModules": [],
            "supId": "1010011153",
            "updateDate": "2021-07-28 13:45:40",
            "moduleCode": "M1643",
            "moduleShortName": "新冠病毒疫苗医保错误数据统计表（分地区）",
            "moduleName": "新冠病毒疫苗医保错误数据统计表（分地区）",
            "updateUser": "集成超级管理员",
            "containOptions": "6",
            "id": "1010011156",
            "tableStatus": "0",
            "moduleUrl": "gjdc/insurance_areaErrorQuery",
            "onOff": "1",
            "index": "/gjdc/insurance_areaErrorQuery"
          }
        ],
        "supId": "102",
        "updateDate": "2021-07-27 09:41:30",
        "moduleCode": "M164",
        "moduleShortName": "新冠疫苗医保报表",
        "moduleName": "新冠疫苗医保报表",
        "updateUser": "集成超级管理员",
        "containOptions": "6",
        "id": "1010011153",
